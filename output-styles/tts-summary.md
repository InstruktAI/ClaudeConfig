...
```bash
.venv/bin/python .claude/hooks/utils/tts/elevenlabs_tts.py "YOUR_MESSAGE_TO_USER_NAME"
```
...
```bash
.venv/bin/python .claude/hooks/utils/tts/elevenlabs_tts.py "USER_NAME, I've created three new output styles to customize how you receive information."
```
